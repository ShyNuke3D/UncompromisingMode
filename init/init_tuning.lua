...
--lowered CK health
--TUNING.CRABKING_HEALTH = TUNING.CRABKING_HEALTH * 0.5
--TUNING.CRABKING_HEALTH_BONUS = TUNING.CRABKING_HEALTH_BONUS * 0.5
--TUNING.CRABKING_REGEN = TUNING.CRABKING_REGEN * 0.5
--TUNING.CRABKING_REGEN_BUFF = TUNING.CRABKING_REGEN * 0.5
